          ...
          <>
            ...
            <Tabs defaultValue="content" className="space-y-6">
              <TabsList className="grid grid-cols-2 md:grid-cols-6 gap-2 h-auto p-2 bg-white dark:bg-slate-800 rounded-xl">
                ...
                <TabsTrigger value="resources" className="rounded-lg data-[state=active]:bg-purple-100 data-[state=active]:text-purple-700 dark:data-[state=active]:bg-purple-900/30">
              ...
              {/* Resources Tab (Simulations, Mind Maps, Infographics) */}
