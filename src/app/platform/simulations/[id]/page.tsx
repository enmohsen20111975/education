...
import { ElectricCircuitSimulation } from "@/components/simulations/physics/ElectricCircuitSimulation";
import { AtomicStructureSimulation } from "@/components/simulations/chemistry/AtomicStructureSimulation";
...
export default function SimulationPage() {
  ...
  // Render the appropriate simulation component
  const renderSimulation = () => {
    switch (simId) {
      case "sim-physics-1":
        return <MotionSimulation language={language} />;
      case "sim-physics-5":
        return <ElectricCircuitSimulation language={language} />;
      case "sim-chem-1":
        return <AtomicStructureSimulation language={language} />;
      case "sim-calc-scientific":
        return (
